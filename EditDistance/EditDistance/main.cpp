...
//    BehaviorObj r1=BehaviorObj("r","file1");
//    BehaviorObj r=BehaviorObj("r","file1");
//    BehaviorObj w1=BehaviorObj("w","file1");
//    BehaviorObj w=BehaviorObj("w","file1");
//    BehaviorObj r2=BehaviorObj("r","file2");
//    BehaviorObj t=BehaviorObj("t","file2");
//    BehaviorObj n=BehaviorObj("n","file2");
//    BehaviorObj w2=BehaviorObj("w","file2");
//    
//    BehaviorObj a=BehaviorObj("a","file2");
//    BehaviorObj b=BehaviorObj("b","file2");
//    BehaviorObj c=BehaviorObj("c","file2");
//    BehaviorObj d=BehaviorObj("d","file2");
//    BehaviorObj e=BehaviorObj("e","file2");
//    BehaviorObj f=BehaviorObj("f","file2");
//    
...
//    cout<<"~~~~"<<endl;
//    MultiEditDistanceBasedOnTwo MED=MultiEditDistanceBasedOnTwo(source);
